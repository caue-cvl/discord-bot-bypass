...
<img src="./images/mee.png" alt="Exemplo imagem" width=22%>
...
<img src="./images/image4.png" width=25%>
...
<img src="./images/image7.png" width=25%>

3- Run the command `pip3 install pyautogui`

<img src="./images/image8.png" width=25%>
...
<img src="./images/image10.png" width=25%>

2- Click `Help` button

<img src="./images/image11.png" width=25%>
...
<img src="./images/image13.png" width=25%>
...
<img src="./images/image14.png" width=25%>
...
<img src="./images/image16.png" width=25%>

8- Enter the  `folder`

<img src="./images/image17.png" width=25%>

9- Find the `EXE file`

<img src="./images/image18.png" width=25%>

10- Move the `EXE file` to the `script folder`

<img src="./images/image19.png" width=25%>
...
<img src="./images/image22.png" width=25%>

<h4>Set messages</h4>

>Change the `TEXT` messages for real messages so you don't get blocked

<img src="./images/image23.png" width=25%>
